...
<html>
 <head>
  <title>Kris returning JSON Data from PHP Script using Ajax Jquery</title>
 ...
 <body>
  ...
  <div class="container" style="width:900px;">
   <h2 align="center">Kris returning JSON Data from PHP Script using Ajax Jquery</h2>
...
$(document).ready(function(){
 $('#search').click(function(){
  var id= $('#employee_list').val();
     /* Making sure the employee value is not blank */
  if(id != '')
  {
   $.ajax({
    url:"fetch.php",
    ...
    method:"POST", 
    data:{id:id},// which data is been sent to server
    dataType:"JSON", // Data type being snt to server
    success:function(data) /* On success data will be stored in the JSON format */
    {
